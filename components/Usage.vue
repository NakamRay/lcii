<template>
  <v-dialog v-model="usageDialog" fullscreen persistent transition="dialog-bottom-transition">
    <v-card>
      <v-toolbar height="50px">
        ...
        <v-btn icon @click="$store.commit('switchUsageDialog')">
          ...
          <v-card flat style="overflow-y: auto;" :height='windowHeight'>
            ...
            <v-card-text>
              ...
              <p>
                ...
                ラムダ式，型環境，簡約過程などが入力されているコンソールの内容を消去します．
                <br><br>
                <code>:clear</code> or <code>:c</code>
              </p>
              <div><b>簡約の中止</b></div>
              <p>
            ...
            <v-card-text>
              <p>
                ...
                次の例は，α変換により束縛変数 <code>x</code> が <code>y</code> にリネームされたことを示しています．
                <br><br>
                - 例<br>
                <code><u>α: x -> y</u></code>
              </p>
